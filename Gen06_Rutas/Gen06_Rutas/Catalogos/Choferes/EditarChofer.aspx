<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarChofer.aspx.cs" Inherits="Gen06_Rutas.Catalogos.Choferes.EditarChofer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <div class="container">
        <div class="row">
            <h3>Editar chofer</h3>
            <h3>Editando Chofer con id de Empleado:
