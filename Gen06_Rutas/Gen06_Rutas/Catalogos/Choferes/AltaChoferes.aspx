<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AltaChoferes.aspx.cs" Inherits="Gen06_Rutas.Catalogos.Choferes.AltaChoferes" %>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvtxtNombre" ControlToValidate="txtNombre"
                        ...
                        ErrorMessage="Nombre de chofer requerido"></asp:RequiredFieldValidator>
                </div>
            </div>
